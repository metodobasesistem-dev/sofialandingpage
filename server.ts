    ...
    try {
      ...
      res.send(`
        <html>
          ...
          <body class="bg-[#080d14] text-white flex items-center justify-center min-h-screen font-sans p-6 relative overflow-hidden">
            ...
            <div class="max-w-md w-full bg-[#0d1522]/80 border border-[#00f2fe]/30 rounded-[2.5rem] p-10 text-center relative z-10 shadow-2xl backdrop-blur-md">
              <div class="w-20 h-20 bg-[#00f2fe]/10 text-[#00f2fe] rounded-full flex items-center justify-center mx-auto mb-8 border border-[#00f2fe]/20 relative">
              ...
              <h1 class="text-3xl font-black mb-3 tracking-tight bg-gradient-to-r from-[#00f2fe] to-[#4facfe] bg-clip-text text-transparent">Conexão Ativada!</h1>
              <p class="text-sm text-[#8fa2be] mb-8 leading-relaxed px-2">A planilha do Google Sheets agora está conectada com sucesso ao site do <strong>Sofia Med</strong>. Todos os novos leads serão gravados em tempo real na tabela.</p>
              
              <div class="bg-[#131d2f]/90 border border-[#00f2fe]/10 rounded-2xl p-6 text-left mb-8 space-y-3">
                <div class="flex justify-between items-center text-xs">
                  <span class="text-gray-400">ID Planilha:</span>
                  <span class="font-mono text-[#00f2fe] truncate max-w-[160px]">${SPREADSHEET_ID}</span>
                </div>
                <div class="flex justify-between items-center text-xs">
                  <span class="text-gray-400">Tokens de Acesso:</span>
                  <span class="text-green-500 font-bold">&#9679; Conectados</span>
                </div>
                <div class="flex justify-between items-center text-xs">
                  <span class="text-gray-400">Ação:</span>
                  <span class="text-gray-300">Gravação em tempo real</span>
                </div>
              </div>

              <button onclick="window.close()" class="w-full py-4 bg-gradient-to-r from-[#00f2fe] to-[#4facfe] text-slate-900 font-extrabold rounded-xl hover:brightness-110 transition-all text-sm uppercase tracking-wider shadow-lg shadow-[#00f2fe]/20">
                Fechar Janela
              </button>
            </div>
          </body>
